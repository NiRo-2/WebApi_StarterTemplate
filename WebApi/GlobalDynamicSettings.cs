namespace WebApi
{
    public static class GlobalDynamicSettings
    {
        ...
        public static string JwtTokenSecret_HashedSecnret { get; set; } //jwt secret key created dynamiclly on load. on every app restart, ***all pre created tokens consider as invalids***
